...
const MyCard1 = () => {
    return (
        <Container>
            <Card style={{ width: '50rem', backgroundColor:"#ffffff"}}>
                <Card.Body>
                    <Card.Title style={{textAlign:"center"}}>НОВОСТЬ</Card.Title><Card.Img style={{objectFit: "cover"}} variant="top" src="https://zakupki-digital.ru/wp-content/uploads/2019/04/%D0%9F%D0%BB%D0%B0%D1%82%D1%84%D0%BE%D1%80%D0%BC%D0%B0-1.jpg" />
                    <Card.Text>
                    ...
                    <div style={{paddingLeft:600}}>
                        <MyButton variant="primary" >Читать подробнее</MyButton></div>
                </Card.Body>
            </Card>
        </Container>
    );
